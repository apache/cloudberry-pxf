...
<div className="note"><b>Note:</b> You must restart both Apache Cloudberry and PXF when you configure the service port number in this manner. Consider performing this configuration during a scheduled down time.</div>
...
<div className="note"><b>Note:</b> You must restart Apache Cloudberry when you configure the host in this manner. Consider performing this configuration during a scheduled down time.</div>
