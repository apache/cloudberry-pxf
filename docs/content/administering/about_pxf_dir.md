...
| logs/                | The PXF runtime [log file](./cfg_logging.md) directory. The `logs/` directory and log files are readable only by the Apache Cloudberry installation user, typically `gpadmin`. |
